data:extend{
  ...
  },
  {
    ...
    results = {
      {type = "item", name = "ll-superposed-polariton", amount = 2, independent_probability = 0.99},
    },
  ...
  },
  {
    ...
    results = {
      {type = "item", name = "ll-right-polariton", amount = 1, shared_probability = {min = 0, max = 0.60}},
      {type = "item", name = "ll-down-polariton", amount = 1, shared_probability = {min = 0.60, max = 0.85}},
      {type = "item", name = "ll-left-polariton", amount = 1, shared_probability = {min = 0.85, max = 0.95}},
      {type = "item", name = "ll-up-polariton", amount = 1, shared_probability = {min = 0.95, max = 1}},
    },
    auto_recycle = false,
  },
  {
    ...
    results = {
      {type = "item", name = "ll-down-polariton", amount = 1, shared_probability = {min = 0, max = 0.60}},
      {type = "item", name = "ll-left-polariton", amount = 1, shared_probability = {min = 0.60, max = 0.85}},
      {type = "item", name = "ll-up-polariton", amount = 1, shared_probability = {min = 0.85, max = 0.95}},
      {type = "item", name = "ll-right-polariton", amount = 1, shared_probability = {min = 0.95, max = 1}},
    },
    auto_recycle = false,
  },
  {
    ...
    results = {
      {type = "item", name = "ll-left-polariton", amount = 1, shared_probability = {min = 0, max = 0.60}},
      {type = "item", name = "ll-up-polariton", amount = 1, shared_probability = {min = 0.60, max = 0.85}},
      {type = "item", name = "ll-right-polariton", amount = 1, shared_probability = {min = 0.85, max = 0.95}},
      {type = "item", name = "ll-down-polariton", amount = 1, shared_probability = {min = 0.95, max = 1}},
    },
    auto_recycle = false,
  },
  {
    ...
    results = {
      {type = "item", name = "ll-up-polariton", amount = 1, shared_probability = {min = 0, max = 0.60}},
      {type = "item", name = "ll-right-polariton", amount = 1, shared_probability = {min = 0.60, max = 0.85}},
      {type = "item", name = "ll-down-polariton", amount = 1, shared_probability = {min = 0.85, max = 0.95}},
      {type = "item", name = "ll-left-polariton", amount = 1, shared_probability = {min = 0.95, max = 1}},
    },
    auto_recycle = false,
  },
}