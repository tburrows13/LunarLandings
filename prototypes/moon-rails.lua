...
data.raw["locomotive"]["space-locomotive"].surface_conditions = moon_only_surface_conditions()
data.raw["locomotive"]["space-locomotive"].ll_surface_conditions = {nauvis = false, luna = true}
data.raw["cargo-wagon"]["space-cargo-wagon"].surface_conditions = moon_only_surface_conditions()
data.raw["cargo-wagon"]["space-cargo-wagon"].ll_surface_conditions = {nauvis = false, luna = true}
data.raw["fluid-wagon"]["space-fluid-wagon"].surface_conditions = moon_only_surface_conditions()
...
legacy_straight_rail.surface_conditions = moon_only_surface_conditions()
...
legacy_curved_rail.surface_conditions = moon_only_surface_conditions()
...
straight_rail.surface_conditions = moon_only_surface_conditions()
...
curved_rail_a.surface_conditions = moon_only_surface_conditions()
...
curved_rail_b.surface_conditions = moon_only_surface_conditions()
