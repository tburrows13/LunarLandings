...
local construction_drone = table.deepcopy(data.raw["construction-robot"]["construction-robot"])
construction_drone.name = "ll-construction-drone"
construction_drone.created_effect = {
  type = "direct",
  action_delivery = {
    type = "instant",
    source_effects = {
      {
        type = "script",
        effect_id = "ll-construction-drone-created",
      },
    }
  }
}
