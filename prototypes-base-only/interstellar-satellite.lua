...
data.raw.item["space-science-pack"].localised_name = {"item-name.ll-interstellar-science-pack"}
data.raw.item["space-science-pack"].localised_description = {"item-description.ll-interstellar-science-pack"}
